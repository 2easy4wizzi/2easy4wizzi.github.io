...
const qTipViewText = [
    {
        view1: "<p style='direction: rtl'>" +
            "לחיצה על עמודה: התפלגות ההצבעה עבור אותו אשכול\<br\>לחיצה על הרקע: מעבר לתוצאות בחירות ארציות" +
            "</p>",
        ...
        view3: "<p style='direction: rtl'>" +
            "לחיצה על עמודה: התפלגות ההצבעה עבור אותו אשכול\<br\>לחיצה על הרקע: חזרה" +
            "</p>"
    },
    {
